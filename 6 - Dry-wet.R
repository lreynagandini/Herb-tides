...
drywet <- drive_get(as_id("https://docs.google.com/spreadsheets/d/1uXvX26hhw2UpkMKrR9LuYJExXlVwg5iShpuMubInI28/edit?gid=1881752280#gid=1881752280"))

drive_download(drywet, overwrite = T)

drywet<-read_xlsx("12 - Descomposicion.xlsx", sheet = "Hoja 5")
...
drywet22 <- drive_get(as_id("https://docs.google.com/spreadsheets/d/1uXvX26hhw2UpkMKrR9LuYJExXlVwg5iShpuMubInI28/edit?gid=1150900912#gid=1150900912"))

drive_download(drywet22, overwrite = T)

drywet22<-read_xlsx("12 - Descomposicion.xlsx", sheet = "Hoja 12")
